            ...
            <div class="containter">
                <div class="card">
                    <div class="card-image">
                        <img src="/images/2D/Jessie_Pose.png" alt="Character">
                    </div>
                    <div class="card-body">
                        <h1>Jessie</h1>
                        <span class="power">Controller</span>
                        <p>Jessie's Shock Rifle shoots energy orbs that bounce between enemies. Her Super deploys a cute but deadly gun turret!</p>
                    </div>
                    <div class="card-footer">
                        <div class="info">
                            <div class="value">1590</div>
