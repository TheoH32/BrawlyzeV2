            ...
            <div class="containter">
                <div class="card">
                    <div class="card-image">
                        <img src="/images/2D/Rico_Pose.png" alt="Character">
                    </div>
                    <div class="card-body">
                        <h1>Rico</h1>
                        <span class="power">Damage Dealer</span>
                        <p>Rico fires a burst of bullets that bounce off walls. His Super is a long barrage of bouncy bullets that pierce targets!</p>
                    </div>
                    <div class="card-footer">
                        <div class="info">
                            <div class="value">480x5</div>
