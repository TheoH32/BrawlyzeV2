            ...
            <div class="containter">
                <div class="card">
                    <div class="card-image">
                        <img src="/images/2D/Jacky_Pose.png" alt="Character">
                    </div>
                    <div class="card-body">
                        <h1>Jacky</h1>
                        <span class="power">Tank</span>
                        <p>Jacky works her Jackhammer to shake up the ground and nearby enemies. Her Super pulls in nearby foes, leaving them in the dust!</p>
                    </div>
                    <div class="card-footer">
                        <div class="info">
                            <div class="value">1860</div>
