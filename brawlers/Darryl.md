            ...
            <div class="containter">
                <div class="card">
                    <div class="card-image">
                        <img src="/images/2D/Darryl_Pose.png" alt="Character">
                    </div>
                    <div class="card-body">
                        <h1>Darryl</h1>
                        <span class="power">Tank</span>
                        <p>Darryl has a powerful double-shotgun attack. His Super move is a reckless roll inside his bouncy barrel!</p>
                    </div>
                    <div class="card-footer">
                        <div class="info">
                            <div class="value">360x10</div>
                            <div class="type">DAMAGE</div>
                        </div>
                        <div class="info">
                            <div class="value">7950</div>
