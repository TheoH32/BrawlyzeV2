            ...
            <div class="containter">
                <div class="card">
                    <div class="card-image">
                        <img src="/images/2D/Bull_Pose.png" alt="Character">
                    </div>
                    <div class="card-body">
                        <h1>Bull</h1>
                        <span class="power">Tank</span>
                        <p>Bull deals massive damage up close with his shotgun. For his Super move, he charges through barriers and knocks back enemies!</p>
                    </div>
                    <div class="card-footer">
                        <div class="info">
                            <div class="value">5x600</div>
